...
-- add genereal property - petalLength and petalWidth have high correlation
-- predicted petalWidth = petalLength * 0.5574664034649219 - 0.6491527433673527
-- -0.5 <= error <= 0.5
...
@property
correlation : Vector Bool n
correlation = foreach i . normalCorr (trainingX ! i)
